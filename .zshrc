...
export PATH="/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/games:/snap/bin:/Android-Studio/bin:/home/anon/Android/Sdk/tools/bin:$JAVA_HOME/bin"
